...
keyboard_size_cap.row('0402', '0603','0805','1206','1210','2010','2512').add('Эл-лит','Керамика','Плёнка')
...
def send_question_element(message):
    if message.text.lower() == 'добавить':
        ...
        bot.register_next_step_handler(message, send_question_size);
...
def send_question_size(message):
